...
func init() {
	...
	// Contexts present ONLY in the extended list must also land in the
	// map (previously dropped — js_comment/svg/mathml had no templates).
